...
- [डेटा](#data)
- [एपीआई एंडपॉइंट](#api-endpoint)
  - [दस्तावेज़ीकरण](#documentation)
  - [प्रांत प्राप्त करें](#get-provinces)
  - [विशिष्ट प्रांत प्राप्त करें](#get-specific-province)
  - [नाम से रीजेंसी प्राप्त करें](#get-regencies-by-name)
  - [विशिष्ट रीजेंसी प्राप्त करें](#get-specific-regency)
  - [एक प्रांत में सभी रीजेंसी प्राप्त करें](#get-all-regencies-in-a-province)
  - [जिलों को नाम से प्राप्त करें](#get-districts-by-name)
  - [विशिष्ट जिला प्राप्त करें](#get-specific-district)
  - [एक रीजेंसी में सभी जिलों को प्राप्त करें](#get-all-districts-in-a-regency)
  - [गाँवों को नाम से प्राप्त करें](#get-villages-by-name)
  - [विशिष्ट गांव प्राप्त करें](#get-specific-village)
  - [जिले के सभी गाँव प्राप्त करें](#get-all-villages-in-a-district)
  - [द्वीपों को नाम से प्राप्त करें](#get-islands-by-name)
  - [विशिष्ट द्वीप प्राप्त करें](#get-specific-island)
  - [सभी द्वीपों को एक रीजेंसी में प्राप्त करें](#get-all-islands-in-a-regency)
- [क्वेरी पैरामीटर्स](#query-parameters)
  - [`sortBy`](#sortby)
  - [`sortOrder`](#sortorder)
- [लाइव डेमो](#live-demo)
- [योगदान](#contributing)
- [समस्या रिपोर्टिंग](#problem-reporting)
  - [बग की रिपोर्ट करना](#reporting-a-bug)
  - [एक नई सुविधा का अनुरोध](#requesting-a-new-feature)
  - [एक प्रश्न पूछना](#asking-a-question)
- [इस परियोजना का समर्थन करें](#support-this-project)
